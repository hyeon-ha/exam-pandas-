...
Original file is located at
    https://colab.research.google.com/drive/1R8Jbm6PKgh9MldeyNr0D9hGLfG88mdY1
"""
...
clean_data.drop(['embark_town', 'alive', 'class'], axis=1,
                inplace=True)
...
clean_data['sex'].replace({'male':0, 'female':1},
                          inplace=True)
...
clean_data['adult_male'] = clean_data['adult_male'].astype(
    'int64')
print(clean_data.adult_male.head())

clean_data['alone'] = clean_data['alone'].astype(
    'int64')
print(clean_data.alone.head())
...
print(training_data['pclass'].head())
...
onehot_data = pd.get_dummies(raw_data[['pclass', 'sex']],
                    columns=['pclass', 'sex'])
print(onehot_data.head())
print(raw_data['sex'].head())
...
training_data = pd.concat([value_data, onehot_data],
                          axis=1)
