# -*- coding: utf-8 -*-
"""exam16_Introduction_to_machine_learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o9lIxkT7aFzLV6I2akur0zM5wbx3NkxG

#머신러닝 입문

https://www.youtube.com/watch?v=aF03asAmQbY&list=WL&index=7&ab_channel=eo
...
def celsisus_to_fahrenheit(x):
    return x * 1.8 + 32

celsius_value = int(input('섭씨온도를 입력하세요.\n'))
print('화씨 온도로', celsisus_to_fahrenheit(celsius_value))
...
data_F = celsisus_to_fahrenheit(data_C)
print(data_C)
print(data_F)
...
f_hist = model.fit(scaled_data_C, scaled_data_F, epochs=1000)

print(model.predict([0.01]))

model.save('after_learning.h5')

plt.plot(f_hist.history['loss'])
plt.show()
...
print('화씨 온도로', np.around(model2.predict([celsius_value/100])*100, 1)[0][0], '입니다.')